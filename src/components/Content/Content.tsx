    ...
    <div className={styles["content"]}>
      <Container>
        ...
        <p style={{ marginTop: "2mm" }}>
          برنامه نویس فول استک متمرکز بر <b>Typescript</b> و <b>Javascript</b> و
          <b>ReactJs</b> در حوزه Frontend و <b>Dotnet Core</b> در حوزه Backend .
          تجربه کار با دیتابیس های <b>PostgreSql</b> و <b>MsSql(SqlServer)</b> .
        </p>
        <p>
          آشنا با استاندارد های <b>UI</b> و <b>UX</b> و مباحث SSR و Module
          Bundling با ابزار های <b>NextJs</b> و <b>Webpack</b> .
        </p>
        <p>
          تجربه کار با State Management های <b>Redux</b> و <b>Recoil</b> و{" "}
          <b>Zustand</b> و <b>React Context</b> برای مدیریت State ها در React .
        </p>
        <p>
        ...
        <p>
          آشنا با سینتکس و ساختار Php و ExpressJs برای همکاری موثر تر با تیم
          توسعه بک اند .
        </p>
        <p>
          علاقه مند به کار تیمی و گروهی و یادگیری مداوم تکنولوژی های به روز .
        </p>
